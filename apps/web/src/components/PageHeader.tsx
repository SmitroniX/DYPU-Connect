...
export default function PageHeader({ title, description, icon, children }: PageHeaderProps) {
    return (
        <div className="page-header sticky top-0 z-30 bg-[var(--ui-bg-surface)]/70 backdrop-blur-3xl border-b border-white/10 shadow-[0_4px_32px_0_rgba(0,0,0,0.1)] px-4 py-3 sm:px-6">
