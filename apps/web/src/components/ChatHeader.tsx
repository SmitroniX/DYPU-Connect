...
export default function ChatHeader({ otherUserId, otherName, otherImage, onAvatarClick, onActionClick, children }: ChatHeaderProps) {
    ...
    return (
        <div className="flex items-center justify-between px-4 pb-3 bg-[var(--ui-bg-surface)]/70 backdrop-blur-3xl border-b border-[var(--ui-border)] z-10 shrink-0 shadow-[0_4px_32px_0_rgba(0,0,0,0.1)] sticky top-0"
