            ...
            <ModuleGuard moduleKey="disableConfessions" moduleName="Confessions">
                ...
                <div className="flex-1 overflow-y-auto">
                    <div className="max-w-2xl mx-auto px-4 py-6 space-y-6">
                        ...
                        {/* Moderated Anonymity Notice */}
                        <div className="flex justify-center mb-6">
                            <div className="bg-[var(--ui-accent)]/10 text-[var(--ui-accent)] text-[11px] px-3 py-2 rounded-lg flex items-center gap-2 max-w-[360px] text-center shadow-sm ring-1 ring-[var(--ui-accent)]/20 animate-[fade-in-up_0.4s_ease-out]">
                                <Lock className="w-3.5 h-3.5 shrink-0" />
                                <span className="leading-tight">Confessions are anonymous to students. Posts are moderated by campus administrators to ensure community safety.</span>
                            </div>
                        </div>
