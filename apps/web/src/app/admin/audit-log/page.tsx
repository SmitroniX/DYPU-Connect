...
const ACTION_CONFIG: Record<string, { label: string; icon: React.ElementType; color: string }> = {
    ...
    report_dismissed: { label: 'Dismissed Report', icon: CheckCircle, color: 'text-[var(--ui-text-secondary)] bg-zinc-500/15' },
    resolve_report: { label: 'Resolved Report', icon: CheckCircle, color: 'text-emerald-400 bg-emerald-500/15' },
    dismiss_report: { label: 'Dismissed Report', icon: CheckCircle, color: 'text-[var(--ui-text-secondary)] bg-zinc-500/15' },
