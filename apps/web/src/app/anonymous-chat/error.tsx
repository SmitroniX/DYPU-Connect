...
export default function AnonymousChatError({ error, reset }: { error: Error; reset: () => void }) {
    return (
        <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4 p-6">
            <div className="h-12 w-12 rounded-2xl bg-red-500/15 flex items-center justify-center">
                <span className="text-2xl">🎭</span>
            </div>
            <h2 className="text-lg font-semibold text-[var(--ui-text)]">Anonymous Chat failed to load</h2>
