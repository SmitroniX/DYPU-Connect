                    ...
                    <div className="space-y-1">
                        {groups.map((group) => (
                            <Link
                                ...
                                className="surface-interactive flex items-center gap-3 px-3 py-3 group"
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <p className="text-[15px] font-medium text-[var(--ui-text-secondary)] group-hover:text-[var(--ui-text)] truncate transition-colors">
                                            {group.name}
                                        </p>
                                    </div>
                                    <p className="text-xs text-[var(--ui-text-muted)] truncate ml-6">{group.description}</p>
                                </div>
